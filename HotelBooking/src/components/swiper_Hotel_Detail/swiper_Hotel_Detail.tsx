...
interface Hotel_Card_Interface {
  redux_Booked_Room: Hotel_Room_Type_Interface | undefined
};
  ...
  return <>
    ...
    <div className="">
      <Swiper slidesPerView={1}
        ...
        {redux_Booked_Room?.images.map((img, index) => {
          return <SwiperSlide key={index}>
            <div className="relative">
              ...
              <p className="absolute bottom-2 right-8 text-white text-sm">
                {(index < 10 ? "0" + (index + 1) : index + 1) + "/" + (redux_Booked_Room.images.length < 10 ? "0" + redux_Booked_Room.images.length : redux_Booked_Room.images.length)}
              </p>
