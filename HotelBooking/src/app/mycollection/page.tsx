...
export default function My_Collection () {
  ...
  return <div className={`customized-bg-gradient min-h-screen ${redux_Collection_List.length >0 ? 'pb-20' : ''} 
    ...
    <div className="flex-1 flex flex-col gap-4 p-4 lg:grid lg:grid-cols-3 lg:px-0">
      ...
      {/** 沒有我的最愛.SVG */}
      {redux_Collection_List.length <=0 ? <div className="flex-1 flex flex-col justify-center items-center gap-4 lg:col-span-3 lg:row-span-1 min-h-[50vh]">
