        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!page || isNaN(page)) {
                    return res
                        .status(400)
                        .json(response_1.ApiResponse.error("頁碼(page)為必填參數"));
                }
                // 處理價格參數
                ...
                if (minPrice !== undefined && minPrice <= 0) {
                    return res
                        .status(400)
                        .json(response_1.ApiResponse.error("最低價格必須大於 0"));
                }
                if (maxPrice !== undefined && maxPrice <= 0) {
                    return res
                        .status(400)
                        .json(response_1.ApiResponse.error("最高價格必須大於 0"));
                }
                const searchParams = {
                    page,
                    limit: 10,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!files || files.length === 0) {
                    return res
                        .status(400)
                        .json(response_1.ApiResponse.error("請選擇要上傳的照片"));
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!Array.isArray(imageUrls) || imageUrls.length === 0) {
                    return res
                        .status(400)
                        .json(response_1.ApiResponse.error("請提供要刪除的照片 URL"));
                }
